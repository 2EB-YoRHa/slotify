...
function config(userConfig, env) {
	...
	const optionsKey = this && this.meta && this.meta.rolldownVersion ? "rolldownOptions" : "rollupOptions";
	const build = {
