      ...
      <div className="mx-auto flex min-h-[calc(100dvh-3rem)] max-w-5xl flex-col sm:min-h-[calc(100vh-5rem)]">
        ...
        <section className="flex flex-1 items-center justify-center">
          <motion.div
            ...
            className="w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-5 text-center shadow-sm sm:p-8 lg:p-10"
          >
            ...
            <div className="mt-8 rounded-2xl bg-slate-50 p-4 text-left sm:p-6">
              <InfoItem
                icon={UsersRound}
                label="Organization"
              ...
              {!authenticated && (
                <>
                  <button
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white px-7 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-50 sm:w-auto"
                  >
                    Sign In
                  </button>
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-cyan-400 px-7 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-cyan-500 sm:w-auto"
                  >
                    Create Account
                  </button>
                </>
...
function InfoItem({ icon: Icon, label, value }: InfoItemProps) {
  return (
    <div className="flex flex-col gap-1 border-b border-slate-200 py-4 last:border-0 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
