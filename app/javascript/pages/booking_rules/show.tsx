  ...
  return (
    <AppLayout>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-3 xl:gap-8">
        ...
        >
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900 dark:shadow-slate-950/30 sm:p-6">
            ...
            <Link
              ...
              className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-400 px-4 py-3 text-sm font-bold text-white shadow-sm shadow-cyan-100 transition hover:-translate-y-0.5 hover:bg-cyan-500 hover:shadow-md dark:shadow-none dark:hover:bg-cyan-300 dark:hover:text-slate-950"
            >
              <Pencil size={16} />
              Change Rules
            </Link>
    ...
    <div className="min-w-0 rounded-xl border border-slate-100 bg-slate-50 p-4 transition-colors dark:border-slate-700 dark:bg-slate-800/60 sm:p-5">
      <div className="mb-4 flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 wrap-break-word text-sm font-bold text-cyan-500 dark:text-cyan-300">
            {value}
          </p>
        </div>
      </div>
