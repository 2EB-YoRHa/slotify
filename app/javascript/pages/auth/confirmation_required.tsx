      ...
      <div className="mx-auto flex min-h-[calc(100dvh-3rem)] max-w-5xl flex-col sm:min-h-[calc(100vh-5rem)]">
        ...
        <section className="flex flex-1 items-center justify-center">
          <motion.div
            ...
            className="w-full max-w-xl overflow-hidden rounded-3xl border border-cyan-100 bg-white shadow-sm transition-colors dark:border-cyan-500/20 dark:bg-slate-900 dark:shadow-slate-950/30"
          >
            <div className="bg-linear-to-b from-cyan-50 to-white px-5 pt-8 text-center transition-colors dark:from-cyan-500/10 dark:to-slate-900 sm:px-10 sm:pt-10">
            ...
            <div className="px-5 pb-8 pt-6 sm:px-10 sm:pb-10 sm:pt-7">
              {email && (
                <div className="rounded-2xl border border-cyan-100 bg-cyan-50 p-5 text-center transition-colors dark:border-cyan-500/20 dark:bg-cyan-500/10">
                  <p className="text-xs font-extrabold uppercase tracking-wide text-cyan-600 dark:text-cyan-300">
                    Confirmation sent to
                  </p>

                  <p className="mt-2 break-all text-base font-black text-slate-950 dark:text-slate-100">
                    {email}
                  </p>
                </div>
              )}
              ...
              {development_manual_links.confirmation_url && (
                <div className="mt-5 rounded-2xl border border-amber-100 bg-amber-50 p-5 transition-colors dark:border-amber-500/20 dark:bg-amber-500/10">
                  <p className="text-xs font-extrabold uppercase tracking-wide text-amber-600 dark:text-amber-300">
                    Development shortcut
                  </p>

                  <p className="mt-2 text-sm font-semibold leading-6 text-amber-700 dark:text-amber-200/90">
                  ...
                  <a
                    ...
                    className="mt-4 flex min-w-0 items-center justify-between gap-3 rounded-2xl bg-white px-4 py-3 text-sm font-black text-cyan-600 shadow-sm transition hover:bg-cyan-50 dark:bg-slate-900 dark:text-cyan-300 dark:shadow-none dark:hover:bg-slate-800"
                  >
              ...
              <div className="mt-5 rounded-2xl bg-slate-50 p-5 transition-colors dark:bg-slate-800/60">
                <div className="flex items-start gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white text-cyan-500 shadow-sm dark:bg-slate-900 dark:text-cyan-300 dark:shadow-none">
              ...
              <form noValidate onSubmit={handleResend} className="mt-6">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-4 transition-colors dark:border-slate-700 dark:bg-slate-900">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <LoadingButton
                      ...
                      loadingText="Sending..."
                      variant="secondary"
                      className="w-full shrink-0 border-cyan-100 px-4 text-cyan-600 hover:bg-cyan-50 dark:border-cyan-500/30 dark:text-cyan-300 dark:hover:bg-cyan-500/10 sm:w-auto"
                    >
                      <RefreshCw size={16} />
                      Resend
                    </LoadingButton>
