    ...
    <AppLayout>
      <div className="mb-8 flex items-start justify-between">
        ...
        <div className="flex rounded-lg border border-slate-200 bg-white p-1 text-sm">
          <button className="rounded-md bg-slate-100 px-4 py-2">Today</button>
          <button className="px-4 py-2 text-slate-500">7d</button>
          <button className="px-4 py-2 text-slate-500">30d</button>
          <button className="px-4 py-2 text-slate-500">All time</button>
        </div>
      </div>
