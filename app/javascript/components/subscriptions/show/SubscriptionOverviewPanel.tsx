...
export default function SubscriptionOverviewPanel({
  ...
  return (
    <motion.section
      ...
      className="mb-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:mb-8 sm:p-6 lg:p-8"
    >
      <div className="mb-6 flex flex-col gap-5 lg:mb-7 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
        <div className="min-w-0">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-3">
            <h2 className="wrap-break-word text-2xl font-extrabold text-slate-950 sm:text-3xl">
              {currentPlanLabel}
            </h2>
      ...
      {currentPlan === "starter" && (
        <div className="mt-6 rounded-2xl border border-cyan-100 bg-cyan-50 p-4 sm:p-5">
          <p className="text-sm font-bold leading-6 text-cyan-700">
...
function InfoCard({ icon: Icon, label, value, helper }: InfoCardProps) {
  return (
    <div className="min-w-0 rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
      ...
      <p className="mt-2 wrap-break-word text-lg font-extrabold text-slate-950">
        {value}
      </p>
...
function OverLimitNotice({ usage }: OverLimitNoticeProps) {
  ...
  return (
    <div className="mb-6 rounded-2xl border border-red-100 bg-red-50 p-4 sm:mb-7 sm:p-5">
...
function OverLimitItem({ label, used, limit, overBy }: OverLimitItemProps) {
  return (
    <div className="rounded-xl bg-white p-4 text-sm">
      <p className="font-extrabold text-red-700">{label}</p>
