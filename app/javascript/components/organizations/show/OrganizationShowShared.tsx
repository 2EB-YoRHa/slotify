...
export function SummaryRow({ label, value }: SummaryRowProps) {
  return (
    <div className="flex flex-col gap-1 border-b border-slate-100 py-3 last:border-0 dark:border-slate-700 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
