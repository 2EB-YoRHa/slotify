  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-slate-100 dark:bg-slate-800">
        ...
        <span className="pointer-events-none absolute right-3 top-3 z-20 rounded-full bg-white/95 px-3 py-1 text-xs font-extrabold text-green-600 shadow-sm ring-1 ring-green-100 transition-colors dark:bg-green-500/15 dark:text-green-300 dark:ring-green-500/20 sm:right-4 sm:top-4">
          Available
        </span>
      </div>
