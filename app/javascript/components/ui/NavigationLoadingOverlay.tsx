    ...
    <AnimatePresence>
      {shouldShow && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 top-16 z-80 overflow-hidden bg-slate-50/95 p-4 backdrop-blur-sm transition-colors dark:bg-slate-950/95 sm:p-6 lg:left-64 lg:p-8"
        >
