    ...
    <div className="space-y-6 sm:space-y-8">
      <div className="min-w-0">
        <motion.h1
          ...
          className="wrap-break-word text-2xl font-extrabold leading-tight text-slate-950 sm:text-3xl"
        >
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <h2 className="mt-2 truncate text-2xl font-extrabold text-slate-950 sm:text-3xl">
            {stat.value}
          </h2>
        </div>
    ...
    >
      <div className="flex flex-col gap-4 border-b border-slate-200 p-5 sm:flex-row sm:items-start sm:justify-between sm:gap-6 sm:p-6">
        ...
        <Link
          ...
          className="inline-flex w-full shrink-0 items-center justify-center gap-2 rounded-lg border border-slate-200 px-4 py-3 text-sm font-bold text-slate-700 transition hover:border-cyan-200 hover:bg-cyan-50 hover:text-cyan-600 sm:w-auto sm:py-2"
        >
          My Bookings
          <ArrowRight size={16} />
        </Link>
      ...
      {reservation ? <NextReservationBody reservation={reservation} /> : <EmptyNextReservation />}
    </motion.div>
  );
}
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5">
      <WorkspacePhoto
        ...
        className="h-56 border-0 bg-slate-100 lg:col-span-2 lg:h-full lg:min-h-72"
      />
      ...
      <div className="min-w-0 p-5 sm:p-6 lg:col-span-3 lg:p-7">
        <div className="mb-5 flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
          <div className="min-w-0">
            <p className="wrap-break-word text-xs font-extrabold uppercase tracking-wide text-cyan-500">
              {formatText(reservation.workspace?.workspace_type)}
            </p>

            <h3 className="mt-2 wrap-break-word text-xl font-extrabold text-slate-950 sm:text-2xl">
        ...
        <div className="grid grid-cols-1 gap-4 rounded-2xl bg-slate-50 p-4 sm:grid-cols-2 sm:p-5">
          ...
          <SummaryItem label="Attendees" value={reservation.attendees_count || 1} />
        </div>
...
function EmptyNextReservation() {
  return (
    <div className="px-5 py-10 text-center sm:p-10">
      ...
      <h3 className="mt-4 text-lg font-extrabold text-slate-950 sm:text-xl">
    ...
    >
      <div className="mb-5 flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-sm leading-6 text-slate-500">Booking shortcuts.</p>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <p className="wrap-break-word text-sm font-extrabold text-slate-950">
            {title}
          </p>
...
function UpcomingBookingCard({
  ...
  return (
    ...
    >
      <Link
        href={`/reservations/${reservation.id}`}
        className="block min-w-0 rounded-2xl border border-slate-200 bg-white p-4 transition hover:-translate-y-0.5 hover:border-cyan-100 hover:bg-cyan-50 hover:shadow-md sm:p-5"
      >
        <div className="mb-4 flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            <p className="wrap-break-word font-extrabold text-slate-950">
              {reservation.workspace?.name || "Workspace removed"}
            </p>

            <p className="mt-1 wrap-break-word text-xs uppercase tracking-wide text-slate-400">
              {formatText(reservation.workspace?.workspace_type)}
            </p>
          </div>
...
function SummaryItem({
  ...
  return (
    <div className="min-w-0">
      ...
      <p className="mt-1 wrap-break-word font-extrabold text-slate-950">{value}</p>
    </div>
  );
}
