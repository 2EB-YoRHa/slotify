...
export default function ReservationNotesCard({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900 dark:shadow-slate-950/30 sm:p-6 lg:p-8">
      ...
      <div className="wrap-break-word rounded-xl bg-slate-50 p-4 text-sm leading-6 text-slate-600 transition-colors dark:bg-slate-800/60 dark:text-slate-300 sm:p-5">
